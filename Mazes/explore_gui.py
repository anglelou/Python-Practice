...
class MazeGUI:
    def __init__(self, maze_grid, maze_dimensions, maze_obstacles, opponent_start_pos):
        ...
        self.screen.setup(width=1.0, height=1.0) # Full Screen
    ...
    def init_screen(self):
        ...
        self.builder.shapesize(18/20) # 20 px is default square size
        ...
        self.treasure.shape("ciricle")
        self.treasure.color("yellow")
        self.treasure.shapesize(18/20) 
        self.treasure.penup()
        ...
        self.draw_maze(self.maze_obstacles)
    ...
    def set_treasure_pos_from_click(self, x, y):
        # Do not allow this once path has started
        if not self.path_started:
            self.treasure_pos = helpers.grid_pos_from_screen_coords((x,y), self.maze_dimesions)
